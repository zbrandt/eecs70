...
\newcommand{\hmwkDueDate}{March 1, 2025}
...
\renewcommand{\part}[1]{\vspace{1em}\textbf{\large Part \Alph{partCounter}}\stepcounter{partCounter}\\}
...
\newcommand{\solution}{\vspace{1em}\textbf{\large Solution}\\}
